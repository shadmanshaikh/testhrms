<div class="container mx-auto p-6">
    <x-card class="bg-white shadow-md rounded-lg p-6">
    ...
    <x-card class="bg-white shadow-md rounded-lg p-6 mt-6">
        <h3 class="text-xl font-semibold mb-4">Response</h3>
        <x-textarea class="bg-gray-100 p-4 rounded w-full" wire:model="response" readonly rows="5"></x-textarea>
    </x-card>
</div>
